...
const db = new Database('data/test.sqlite'); 
db.exec('CREATE TABLE users (id TEXT PRIMARY KEY, email TEXT, username TEXT, role TEXT, created_at TEXT, exams_generated INTEGER, total_api_cost REAL);'); 
